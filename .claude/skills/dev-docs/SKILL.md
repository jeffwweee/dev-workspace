---
name: dev-docs
description: "Documentation creation and updates. Creates and maintains progress.md session logs, PROJECT_CONTEXT.md project overview, and other project documentation. Use for creating initial project documentation, updating progress after work completion, adding project context. Triggers on 'docs', 'documentation', 'update progress', 'create readme'."
---
...
```bash
/dev-docs --update-progress --task TASK-001 --summary "Implemented feature X"
```
...
```bash
/dev-docs --document-decision "Use OAuth2 for authentication" --reason "Security requirements"
```
...
```
User: /dev-docs --update-progress --task TASK-001 --summary "Implemented user login"
