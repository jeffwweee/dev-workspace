---
name: task-complete
description: Use when implementation is complete, all tests pass, and you need to decide how to integrate the work - guides completion of development work by presenting structured options for merge, PR, or cleanup. Triggers on "complete", "finish", "merge", "create PR", "done with task".
---
...
**Called by:**
- **plan-parallel** - After all tasks complete
- **plan-execute** - After all batches complete

**Pairs with:**
- **review-verify** - Run before this skill
