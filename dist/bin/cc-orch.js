...
import { initialize, runLoop, stop, getStatus, submitTask, getCoreAgents } from '../lib/orchestrator';
import { spawnAgent, killAgent, listAgentSessions } from '../lib/spawn-agent';
import { getQueueLength, clearQueue } from '../lib/queue-manager';
...
program.command('archive-list')
    ...
    for (const month of months) {
        ...
        if (data.memories?.length)
            console.log(`  Memories: ${data.memories.length} files`);
...
program.parse();
//# sourceMappingURL=cc-orch.js.map