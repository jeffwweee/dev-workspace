 ...
 */
export function needsArchiving(filePath) {
 ...
 */
export function archiveMemoryFile(agent) {
 ...
 */
export function archiveCompletedProgress() {
 ...
 */
export function archiveHandoffs() {
    if (!fs.existsSync(PROGRESS_DIR)) {
        return { success: true, archived: 0 };
    }
 ...
 */
export function runArchiveCycle() {
